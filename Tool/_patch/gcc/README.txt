...
cygming-{STMP_FIXINC-0,LIMITS_H_TEST-0,{PICFLAG,NO_PIE_CFLAGS,NO_PIE_FLAG}-13},\
cygwin-{ldflags,macro,include-w32api,no-wrap-0,no-manifest,no-host_shared,jit-playback.cc,jit-result.cc},\
mingw-{replace-w64-0,no-manifest-0,gethostname,libgcc-no-libc,include-lib-{a,b,{c,d,e}-0},path-{a,b,c,d,e},compiler-{INCLUDE,LIB},glimits.h}}.patch

14.0.0    b8e9fd535d6093e3a24af858364d8517a767b0d7    2024-04-24    branch point
patch_apply . ../_patch/gcc/{_convert-path,_add_env_var_paths,_copy-headers-of-gcc,_PREFIX_INCLUDE_DIR,_FIXED_INCLUDE_DIR,\
cygming-{STMP_FIXINC-0,LIMITS_H_TEST-0,PICFLAG-14},\
cygwin-{ldflags,macro,include-w32api,no-wrap-0,no-manifest,no-host_shared,jit-playback.cc,jit-result.cc},\
...
patch_apply . ../_patch/gcc/{_convert-path,_add_env_var_paths,_copy-headers-of-gcc,_PREFIX_INCLUDE_DIR,_FIXED_INCLUDE_DIR,\
cygming-{STMP_FIXINC-1,LIMITS_H_TEST-1,PICFLAG-14},\
