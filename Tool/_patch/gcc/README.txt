...
patch_apply . ../_patch/gcc/{convert-path,cygwin-{ldflags,limits.h-0,macro,no-wrap,no-tsware},mingw-{ldflags,gethostname,libgcc-inhibit_libc,include-{a,b,c},path-{a,b,c},compiler-INCLUDE}}.patch

15.0.0    abeeccef92892fe519cc417b30ae22ce9da2d5e6 2024-08-28
patch_apply . ../_patch/gcc/{convert-path,cygwin-{ldflags,limits.h-1,macro,no-wrap,no-tsware},mingw-{ldflags,gethostname,libgcc-inhibit_libc,include-{a,b,c},path-{a,b,c},compiler-INCLUDE}}.patch
