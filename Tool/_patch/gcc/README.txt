...
_PREFIX_INCLUDE_DIR,_FIXED_INCLUDE_DIR,cygming-{STMP_FIXINC-0,LIMITS_H_TEST-0},cygming-no-pic/13/{a,b,c,d,e},cygwin-{ldflags,macro,include-w32api,no-wrap-0,no-manifest},\
