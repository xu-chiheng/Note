...
_PREFIX_INCLUDE_DIR,_FIXED_INCLUDE_DIR,cygming-{STMP_FIXINC-0,LIMITS_H_TEST-0,no-c++11,no-pic-pie-{a,b}},cygwin-{ldflags,macro,include-w32api,no-wrap-0,no-manifest},\
...
patch_apply . ../_patch/gcc/{_convert-path,_add_env_var_paths_to_include_path,_add_env_var_paths_to_library_path,\
_PREFIX_INCLUDE_DIR,_FIXED_INCLUDE_DIR,cygming-{STMP_FIXINC-1,LIMITS_H_TEST-1,no-c++11,no-pic-pie-{a,b}},cygwin-{ldflags,macro,include-w32api,no-wrap-1,no-manifest},\
