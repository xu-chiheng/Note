...
patch_apply . \
../_patch/llvm/{_prevent-versioning-{a,b},_cmake-option,_cmake-dump,\
cygwin-{support-tls,va-list-kind,lld-{findFile,searchLibrary,LIB},cmodel-2,driver-4,general-{a,b,c},macro,CGCall.h,X86ISelLowering.cpp,X86ISelDAGToDAG.cpp-{a,b,c}},\
mingw-{git-revision,ldflags,pthread,emutls-1,findgcc-1,Value.h,compiler-{INCLUDE,LIB},driver-a,GCC-O3},\
pseudo-{gen-Main,lib-Grammar}.cpp}.patch
